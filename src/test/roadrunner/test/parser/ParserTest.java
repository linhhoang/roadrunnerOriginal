...
package roadrunner.test.parser;
...
public class ParserTest extends TestCase {
    ...
    public ParserTest(java.lang.String testName) throws Exception {
        ...
        byname2 = new Sample(new URL("file:"+FixtureOnFile.getSampleFile(sfn2)), rufus.getPrefs(), "utf8");
        bynameY = new Sample(new URL("file:"+FixtureOnFile.getSampleFile(sfnY)), rufus.getPrefs(), "utf8");
    }
