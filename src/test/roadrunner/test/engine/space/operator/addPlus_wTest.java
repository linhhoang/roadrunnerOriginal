...
package roadrunner.test.engine.space.operator;
...
import roadrunner.test.FixtureOnFile;
import roadrunner.test.parser.*;
import roadrunner.util.Util;
import roadrunner.bidi.Region;
import roadrunner.config.Config;
import roadrunner.engine.space.operator.addPlus;
import roadrunner.engine.space.operator.addPlus_w;
...
public class addPlus_wTest extends TestCase {
    ...
    public void setUp() throws Exception {
        this.sample_pls1 = new Sample(new URL("file:"+FixtureOnFile.getBasicFile(pls1)), Config.getPrefs(), "utf8");
        this.sample_pls2 = new Sample(new URL("file:"+FixtureOnFile.getBasicFile(pls2)), Config.getPrefs(), "utf8");
    }
