...
public class SearchSpace extends Backtracker
{
    ...
    /**
     * Lo stato dell'allineamento si riduce ad una semplice exp. reg., ma
     * servono anche mismatches ed operatori In questo spazio degli stati:
     * Operatore: stato -> { stato }
     */

    /*
     * Lavorando con le regioni piuttosto che le espressioni si hanno due
     * vantaggi sostanziali: 1) rende la classe piu' generale perche per passare
     * da una exp ad una regione basta fare exp.asRegion(); 2) si evitano alcune
     * materializzazioni che costano parecchio perche' implicano il cloning dei
     * nodi delle exp
     */
    ...
    public SearchSpace(Expression exp, TokenList tokenlist, Direction dir, int minDOMdepth)
    {
    ...
    private int solutions = 0; // this fields and next two methods only for
                               // logging
