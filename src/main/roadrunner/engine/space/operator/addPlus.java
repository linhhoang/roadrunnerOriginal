...
public abstract class addPlus extends SquareOperator implements Operator {
 ...
 */
    ...
    public abstract Collapser getAfterCollapser(Expression square, SearchSpace space);
    
    public Region getRegionAfterSquare() {
        return getSearcher().getRegionAfterOccurrence(k-1);
    }
    
    public Expression getCandidateSquare() {
        return this.csquare;
    }
    
    public ExpressionRegion getExtension() {
