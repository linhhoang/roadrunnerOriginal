...
public class addPlus_w extends addPlus implements Operator {
    ...
    private static class Factory extends SquareOperatorFactory {
        ...
        public Operator createOperator(int k) {
    ...
    public static OperatorFactory getFactory(MismatchPoint m) {
    ...
    public Collapser getAfterCollapser(Expression csquare, SearchSpace space) {
