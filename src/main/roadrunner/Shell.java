...
public class Shell
{
    ...
    static final public String WRAPPER_NAME_DEFAULT = "outWrapper"; // default
                                                                    // name of
                                                                    // wrappers

    /**** Command Line Options */
    static private String wrapperName = "out"; // name of the wrapper (to derive
                                               // names of produced files)


    static private void setWrapperName(String s)
    {
        Shell.wrapperName = s;
    }
     ...
     * @return wrapper name
     */
    static public String getWrapperName()
    {
        return Shell.wrapperName;
    }
    ...
    static public void disguiseShell(String[] argv, String inputEncoding) throws Exception
    {
        ...
        if (!repository.isEmpty())
        {
            ...
            repository.setWrappersNamesIds(getWrapperName()); // set wrappers
                                                              // unique ids
            ...
            log.info("Sorry: none wrapper inferred.");
    }
